...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "covoiturage"),
        "USER": os.getenv("DB_USER", "covoiturage"),
        "PASSWORD": os.getenv("DB_PASSWORD", "covoiturage"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "API de la plateforme de covoiturage",
    "VERSION": "1.0.0",
}

# Email (SMTP via .env — sinon console)
...
DEFAULT_FROM_EMAIL = os.getenv(
    "DEFAULT_FROM_EMAIL",
    "Covoiturage <noreply@covoiturage.local>",
)
